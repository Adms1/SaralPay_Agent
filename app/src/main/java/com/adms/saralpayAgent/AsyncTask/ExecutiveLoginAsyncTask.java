...
public class ExecutiveLoginAsyncTask extends AsyncTask<Void, Void, HashMap<String, String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner = null;

    public ExecutiveLoginAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    protected HashMap<String, String> doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.ExecutiveLogin), param);
            result = ParseJSON.parseAgentLoginJson(responseString);
        } catch (Exception e) {
