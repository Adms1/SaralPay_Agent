...
public class GetCustomerIDByNumberAsyncTask extends AsyncTask<Void, Void, HashMap<String, String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner = null;

    public GetCustomerIDByNumberAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    protected HashMap<String, String> doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetCustomerIDByNumber), param);
            result = ParseJSON.parseCreateCustomerByIdNumberJson(responseString);
        } catch (Exception e) {
