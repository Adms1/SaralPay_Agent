...
public class CreateCustomerByAgentAsyncTask extends AsyncTask<Void, Void, HashMap<String, String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner = null;

    public CreateCustomerByAgentAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    protected HashMap<String, String> doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.CreateCustomerByAgent), param);
            result = ParseJSON.parseCreateCustomerByAgentJson(responseString);
        } catch (Exception e) {
