...
public class AssignQRCodeToCustomerAsyncTask extends AsyncTask<Void, Void, HashMap<String, String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner = null;

    public AssignQRCodeToCustomerAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    protected HashMap<String, String> doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.AssignQRCodeToCustomer), param);
            result = ParseJSON.parseAssignQRCodeToCustomerJson(responseString);
        } catch (Exception e) {
